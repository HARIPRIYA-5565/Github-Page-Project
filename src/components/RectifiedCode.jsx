...
function RectifiedCode(){
   ...
   <> <div className="  max-w-7xl mx-auto">
            ...
            <nav className=" py-4 flex  justify-between sm:px-2 ">
                ...
                <div className="divide-x items-center divide-gray-300 space-x-2 sm:flex  hidden ">
                    ...
                    {/* <!--   input is an inline-block element thus but it is  wrapped with the inline element which an be instead done with the div tag , thus we wrap it  with the div tag  */}
                    {/* (span it used to  style small components and it takes only the required space) --> */}
                    <div><input className="border border-gray-700 rounded-md py-1 px-2" type="text" placeholder='Type your text here'>
                        <button className="border border-gray-600 py-1 rounded-md px-1 hover:bg-gray-300"> {">_"}
                        </button>
                    </input></div>

                    {/* <!--  button is an inline element thus it  is wrapped here with the span tag which is again the inline element and used to style small  parts  thus we will wrap it with the div tag which is a block level element --> */}
                    <div className="flex gap-2 items-center pl-2">
                        ...
                        <img className="h-14 w-14 border border-gray-600 rounded-full"></img>
                    </div>
                </div>
                {/* <!-- mob view part --> */}
            ...
            {/* <!--  headder containing the list options  --> */}
            <div className=" border-b pb-2 flex px-2 justify-between">
               ...
               {/* <!-- top section having hedder of the main section  -->  */}
            ...
            <div className=" sm:flex hidden justify-between mx-4 border-b py-3">
                ...
                <div className="flex gap-2 ">
                    {/* <!--  we can use div as it is block level element and the button was the inline  element --> */}
                    <div>
                    ...
                    <div>
                        <a className="hover:bg-gray-300 flex gap-2 px-2 items-center py-1 cursor-pointer border rounded-md" href=""> <img className="h-4 w-4 border"></img> <span>Unwatch</span> <span className="bg-gray-200 rounded-full px-1 text-sm">1</span> <img className="h-4 w-4 border"></img>  </a></div>
                    <div className="flex items-center">
                        <a className="hover:bg-gray-300 flex gap-2 px-2 items-center py-1 cursor-pointer rounded-l-md  border-b border-t border-l" href=""> <img className="h-4 w-4 border"></img> <span>Fork</span> <span className="bg-gray-200 rounded-full px-1 text-sm">1</span> <img className="h-4 w-4 border"></img>  </a><span className="px-2 py-1 border rounded-r-md hover:bg-gray-200">{">"}</span></div>
                    <div className="flex items-center">
            ...
            <div className="sm:hidden block space-y-2 py-4 px-2 border-b ">
                 {/* <!--  we over here are using div to  divide the sections and wrap the whole section seperately as wrapping with the span it wss a inline element and that is used to style small parts  or the small texts -->  */}
                <div>
                    {/* <!-- we are not trying to  change the wrapping tag over here because we want it side by side in alignment and by using div we need to use  css to style which  can be achieved by  the inline element  --> */}
                    <button>

                        {/* <!-- over here whenever the link is clicked it opens the related page , thus here anchor tag is used for that as it allows this feature --> */}
  ...
  <div className="sm:col-span-9  col-span-1 sm:mx-6 mx-3 pt-4 sm:pt-0">
    <div className="flex flex-row justify-between">
      ...
      {/* <!-- instead of span used div tag to wrap and create a section(part) as span is used to style  small text --> */}
    <div className="flex sm:flex-row flex-col flex-wrap gap-2 ">
      ...
      {/* <!-- instead of span used div tag to wrap and create a section(part) as span is used to style  small text --> */}
       <div className="sm:flex gap-2 py-2 hidden">
      <button className="flex items-center">
...
{/* <!--  we use div over here because we are seperating the  icon --> */}
      ...
      <div className="flex justify-between px-2 border-b py-1" >
        {/* <!-- we use div over here because we have two items and we are  creating a section containing those two items instead of styling the small text  --> */}
        <div className="flex items-center py-2 text-base"><img className="h-8 w-8 border border-gray-600 rounded-full "></img>
     <a className="cursor-pointer hover:underline font-medium  pl-2" href="">HARIPRIYA-5565</a>
     <span className="hover:text-blue-600 hover:underline cursor-pointer pl-1 sm:block hidden"> first commit</span> </div>
      {/* <!-- we use div over here because we have two items and we are  creating a section containing those two items instead of styling the small text  --> */}
...
<a className="hover:text-blue-600 hover:underline  sm:hidden block  items-center cursor-pointer   " href=""> <img className="h-4 w-4 border"></img></a>
      ...
      <table className="w-full">
        ...
        <div className="bg-blue-500 border-2 border-blue-600 rounded-lg flex justify-between px-4 py-4">
          {/* <!-- we use div over here creating two parts containing one each  --> */}
          <div>  <p className="text-white sm:text-base text-sm">Help people interested in <br className="sm:hidden block"/>this repository<br className="sm:hidden block"/> understand your project by adding a README.</p></div>
         <div> <button className="bg-green-700 text-white px-3 py-1 rounded-md sm:text-base hover:bg-gray-800 text-xs">
            Add a README
            </button></div>
          </div>
  </div>
...
<div className="space-y-2 pb-4 sm:block hidden" >
  {/* <!-- we use div instead of span for creating the part containing headding and Icon --> */}
 <div className="flex justify-between"> <h2 className="font-medium">About</h2>
  <img className="h-6 w-6 "></img></div>
...
75.7%
  ...
  <div className="py-4 space-y-6">
    {/* <!-- we use div to wrap the items as we cannot wrap the block level elemengt with the inline element i.e span and headding tags are block level element --> */}
   <div className="leading-5"> <h2 className="font-medium">Suggested Workflows</h2>
    <h3 className="text-sm text-gray-800" > Based on your tech stack</h3></div>
    <div className="border border-gray-600 rounded-lg  py-4  space-y-2 px-2">
      <div className="flex justify-between">
         {/* <!-- we use div to wrap the items as we cannot wrap the block level elemengt with the inline element i.e span and headding tags are block level element --> */}
        <div className="flex"><img className="h-8 w-8 border border-gray-600 rounded-full"></img>
      <h2 className="font-medium pl-2">Actions Importer</h2></div>
     <div > <button className="border border-gray-400 rounded-md px-4 text-sm"><a href="">Set up</a></button></div>
     </div>
       {/* <!-- we use div to wrap the items as we cannot wrap the block level elemengt with the inline element i.e span and paragraph tags are block level element --> */}
      <div className="flex justify-center  ">
        <p className='text-xs  '>Automatically convert CI/CD files to <br/>YAML for GitHub Actions.</p>
        </div>
      </div>
      <div className="border border-gray-600 rounded-lg  py-4  space-y-2 px-2">
      <div className="flex justify-between"><div className="flex"><img className="h-8 w-8 border border-gray-600 rounded-full"></img>
      <h2 className="font-medium pl-2">SLSA Generic generator</h2> </div>
      <div><button className="border border-gray-400 rounded-md text-sm px-2 "><a href="">Configure</a></button></div>
      </div>
      <div className="flex justify-center  ">
      ...
      <div className="border border-gray-600 rounded-lg  py-4  space-y-2 px-2">
      <div className="flex justify-between"><div className="flex"><img className="h-8 w-8 border border-gray-600 rounded-full"></img>
      <h2 className="font-medium pl-2">Jekyll using Docker image</h2> </div><div><button className="border border-gray-400 rounded-md text-sm px-2 "><a href="">Configure</a></button></div>
      </div>
      <div className="flex justify-center">
      ...
      <div className='flex justify-between '>
      <div className="text-blue-600  text-sm hover:text-blue-800 hover:underline ">
       <a href=""> More workflows</a>
      </div>
       <div className="text-gray-600 text-sm  hover:text-gray-800 hover:underline">
...
About</a></li>
      ...
      {/* <!-- we use div to wrap the items as we cannot wrap the block level elemengt with the inline element i.e span and headding tags are block level element --> */}
    <div className="sm:hidden flex pt-4 gap-1">
    <a href=""><img className="h-4 w-4 rounded-full border border-gray-500"></img></a>
    <h4 className="text-gray-700 text-xs">© 2023 GitHub, Inc.</h4>
    </div>
  </footer></>
